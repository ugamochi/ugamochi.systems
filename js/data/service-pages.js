export const servicePages = {
  "ai-lead-pipeline-qualification-engine": {
    ...
    "metaDescription": "Client-owned lead pipeline automation with secure intake, qualification scoring, and routing to hot, warm, and cold response paths.",
    "subtitle": "Turn raw inquiries into prioritized sales action with a client-owned intake system that captures, protects, scores, and routes leads in seconds.",
    "pricing": {
    ...
    "proof": [
      {
        "value": "93%",
        "label": "Faster lead response compared to manual assignment"
      },
      {
        "value": "<10s",
        "label": "Typical scoring and routing latency"
      },
      {
        "value": "24/7",
        "label": "Always-on intake without manual triage bottlenecks"
      }
    ],
    ...
    "blueprint": {
      ...
      "description": "A modular intake architecture that blocks junk, classifies intent, and pushes each lead to the right action path.",
      "modules": [
        {
          "title": "Capture",
    ...
    "ownershipNote": "Client-owned setup: your workspace, your keys, your billing, your data. No lock-in handover risk.",
    "packages": [
      {
        "name": "Starter",
    ...
    "nextStepTitle": "If lead follow-up is still manual, this is usually the highest-leverage automation to implement first.",
    "contact": {
  ...
  "automated-performance-reporting": {
    ...
    "metaDescription": "Unify marketing, sales, and operations data into always-current dashboards with consistent KPI definitions and alerting.",
    "subtitle": "Replace stale exports and ad-hoc reports with a client-owned reporting stack that drives faster decisions.",
    "pricing": {
    ...
    "proof": [
      {
        "value": "Live",
        "label": "Dashboards instead of stale weekly exports"
      },
      {
        "value": "Unified",
        "label": "KPI definitions aligned across stakeholders"
      },
      {
        "value": "Alerted",
        "label": "Threshold and anomaly signals routed automatically"
      }
    ],
    ...
    "nextStepTitle": "If reporting still depends on manual merges, this is one of the highest-leverage systems upgrades.",
    "contact": {
  ...
  "client-onboarding-automation": {
    ...
    "metaDescription": "Trigger-based onboarding automation from close-won to delivery kickoff with standardized provisioning and communication.",
    "subtitle": "Trigger every onboarding step automatically from contract or payment events, so your team delivers a consistent first impression.",
    "pricing": {
    ...
    "proof": [
      {
        "value": "<24h",
        "label": "Typical onboarding cycle after automation"
      },
      {
        "value": "Fewer",
        "label": "Missed setup steps and handoff errors"
      },
      {
        "value": "Higher",
        "label": "Client onboarding consistency and clarity"
      }
    ],
  ...
  "document-intelligence-pdf-to-data": {
    ...
    "metaDescription": "Automate PDF extraction into structured records with validation, exception handling, and client-owned infrastructure.",
    "subtitle": "Convert unstructured PDFs into clean, validated data flows so operations stop retyping and start scaling.",
    "pricing": {
    ...
    "proof": [
      {
        "value": "90%",
        "label": "Reduction in manual data entry effort"
      },
      {
        "value": "Faster",
        "label": "Turnaround from document arrival to usable records"
      },
      {
        "value": "Safer",
        "label": "Validation and exception gates before write operations"
      }
    ],
    ...
    "nextStepTitle": "If your team still retypes PDFs, this is usually the fastest operational win available.",
    "contact": {
  ...
  "internal-company-brain-rag": {
    ...
    "metaDescription": "Build a source-cited internal knowledge system so teams get reliable answers faster with client-owned infrastructure.",
    "subtitle": "Transform scattered docs into a source-cited answer layer that reduces internal bottlenecks and speeds team execution.",
    "pricing": {
    ...
    "proof": [
      {
        "value": "Faster",
        "label": "Internal answer retrieval and onboarding speed"
      },
      {
        "value": "Cited",
        "label": "Responses grounded in approved internal sources"
      },
      {
        "value": "Controlled",
        "label": "Role-aware access and client-owned data stack"
      }
    ],
    ...
    "nextStepTitle": "If your team keeps asking the same operational questions, this system compounds quickly.",
    "contact": {
  ...
  "openclaw-setup-security-hardening": {
    ...
    "metaDescription": "Deploy OpenClaw with policy-first hardening, sandbox controls, channel/provider strategy, and client-owned handover.",
    "subtitle": "Deploy OpenClaw as production infrastructure, not a side experiment: hardened permissions, sandbox policy, channel governance, testing, and handover.",
    "pricing": {
      "starter": "EUR 1,500-2,500",
      "growth": "EUR 3,500-6,500",
    ...
    "proof": [
      {
        "value": "Policy-first",
        "label": "Permissions and sandbox rules before traffic"
      },
      {
        "value": "Multi-channel",
        "label": "Controlled integration across approved channels"
      },
      {
        "value": "Handover-ready",
        "label": "Runbook, QA, and ownership transfer included"
      }
    ],
